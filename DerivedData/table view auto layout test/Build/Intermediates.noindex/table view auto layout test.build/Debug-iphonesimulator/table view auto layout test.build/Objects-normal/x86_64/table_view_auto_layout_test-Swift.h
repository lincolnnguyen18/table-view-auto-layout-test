...
#ifndef TABLE_VIEW_AUTO_LAYOUT_TEST_SWIFT_H
#define TABLE_VIEW_AUTO_LAYOUT_TEST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="table_view_auto_layout_test",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC27table_view_auto_layout_test11AppDelegate")
...
SWIFT_CLASS("_TtC27table_view_auto_layout_test13SceneDelegate")
...
SWIFT_CLASS("_TtC27table_view_auto_layout_test17TestTableViewCell")
...
SWIFT_CLASS("_TtC27table_view_auto_layout_test14ViewController")
